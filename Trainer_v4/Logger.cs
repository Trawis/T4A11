...
namespace Trainer_v4
{
	public static class Logger
	{
		...
		public static void Log(this float str) => ConsoleLog(str.ToString(CultureInfo.InvariantCulture));
		public static void Log(this double str) => ConsoleLog(str.ToString(CultureInfo.InvariantCulture));
